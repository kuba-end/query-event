...
final class BitBagPluginCommonsCrossSellingExtension extends Extension
{
    public function load(array $config, ContainerBuilder $container): void
    {
        ...
        $loader->load('crossSelling_event_factory.xml');
        $loader->load('crossSelling_query_dispatcher.xml');
    }
